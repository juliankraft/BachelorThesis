...
There is still some unclarity about the actual sequences - exif information limited but info is imprinted visually - an OCR model can be applied to extract this information
