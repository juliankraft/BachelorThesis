...
\section{Methods}\todo{reviewed - changes made and some parts added}
\label{methods}

    \subsection{Dataset}\todo{Is the thing with the sessions now clear? Is tha table sufficient as is or does it need more detail?}
    ...
    \subsubsection{Best Model Evaluation}\todo{this is not yet reviewed}
