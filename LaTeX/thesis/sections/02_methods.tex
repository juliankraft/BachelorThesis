...
\label{methods}
    ...
    \todo{add sequenc count to legend.}
    \begin{figure}[H]
    \centering
    ...
    \subsubsection{Best Performing Model Architecture Evaluation}\todo{ensure clarity - model vs architecutre trough the whole thesi}
