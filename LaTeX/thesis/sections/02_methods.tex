...
\label{methods}
    ...
    While the detection was performed once for the whole dataset, the selection, image processing, and data splitting were implemented to be done on the fly.
        ...
        Cropping was done using the \acp{BBox} from the \ac{MD} detection extending the \ac{BBox} in order to cut the ratio expected by the model.
    ...
    \subsection{Sequence Classification} \todo{Is this illustration reasonable?}
    ...
    \subsection{Evaluation}\todo{this was signifficantly changed}
    ...
    \subsubsection{Best Model Evaluation}
