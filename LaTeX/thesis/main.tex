...
%----------------------------------------------------------------------------------------
\projecttitle{WorkingTitle: DeepLearning powered Image Classification - of Camera Trap Images}
...
\addcollaborator{A}{Glüge}{Stefan}{glue@zhaw.ch}{2}
\addcollaborator{B}{Matthias}{Nyfeler}{nyfe@zhaw.ch}{2}
...
\include{sections/06_acknowledgment_declaration}
