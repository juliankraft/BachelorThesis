...
\begin{itemize}
    ...
    \item \textbf{Animal Detection:} A way to scann the images for animals is needed to select suitable images and determine the \ac{ROI} for classification.

    \item \textbf{Data Processing:} Develop a processing pipeline that transforms the selected \acp{ROI} to a format suitable for the training of a classification model.
