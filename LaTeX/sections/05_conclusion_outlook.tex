...
\caption{Top 5\% of a camera trap image —-- it was processed with the \textzt{Tesseract} \ac{OCR} model. The output string was: \enquote{\texttt{2019-09-04 1:02:09 AM M 1/3 \#9 10\textdegree C}}.}
